...
const tabsParam = ['Yesterday', 'Last 7 days', 'Last 30 days', 'This week', 'This month']
...
const handleExport = async () => {
  try {
    const confirm = await ElMessageBox.confirm(
      'Do you want to export the operational data from the last 30 days?',
      'Export data',
      {
...
<template>
  <div class="title-index">
    <div class="tab-change">
      ...
      <div class="get-time">
        <p>Selected time: &nbsp;{{ tateData[0] }}&nbsp; to &nbsp;{{ tateData[tateData.length - 1] }}</p>
      </div>
    </div>
    <el-button type="success" @click="handleExport">Data Export</el-button>
  </div>
  <div class="page">
    <el-row :gutter="20">
      <div class="turnover">
